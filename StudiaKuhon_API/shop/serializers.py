...
from utils.models import Handle, Style, Material, Palette, Photo
from .models import Product
from utils.serializers import StyleSerializer, PhotoSerializer, HandleSerializer, ColourSerializer, MaterialSerializer
